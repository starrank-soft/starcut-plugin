...
1. Establish the exact project with `mcp__plugin_starcut_starcut__list_projects`,
   `mcp__plugin_starcut_starcut__create_project`, or `mcp__plugin_starcut_starcut__open_project`.
2. If `mcp__plugin_starcut_starcut__create_project` or `mcp__plugin_starcut_starcut__open_project` returns
...
6. Use `mcp__plugin_starcut_starcut__glob` or `mcp__plugin_starcut_starcut__head` on the returned Artifact
