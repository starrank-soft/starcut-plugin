---
name: media-import
description: Use when finding license-compatible image, video, music, or sound-effect media on the web, downloading it for one StarCut project, or importing local image, video, audio, or document files that Codex can read into a project Artifact library.
---
...
2. If `mcp__starcut__create_project` or `mcp__starcut__open_project` returns
