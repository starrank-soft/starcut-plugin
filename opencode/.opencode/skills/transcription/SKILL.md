...
4. Call `starcut_client_call` with `command: "get_transcript"` on each generated Audio Artifact.
5. If prepared, call `starcut_run_task` with each returned Task input.
